...
export default function VendorLayout() {
  ...
  const handleLogout = async () => { navigate('/login', { replace: true }); setTimeout(() => vendorLogout(), 100); };
          ...
          <div style={{ background: 'var(--vd-surface)', border: '1px solid var(--vd-border)', padding: '40px', borderRadius: '24px', maxWidth: '400px', textAlign: 'center', boxShadow: 'var(--vd-shadow-md)' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
              ...
              <div style={{ display: 'flex', gap: '1rem', width: '100%' }}>
                <button className="vd-btn-primary" onClick={() => void checkApprovalStatus()} style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8, padding: '14px', borderRadius: '12px', background: 'var(--vd-primary)', color: '#fff', border: 'none', fontWeight: 700, cursor: 'pointer' }}>
